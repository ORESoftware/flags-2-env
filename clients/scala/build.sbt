...
ThisBuild / homepage := Some(url("https://github.com/flags-2-env/flags-2-env"))
ThisBuild / scmInfo := Some(ScmInfo(url("https://github.com/flags-2-env/flags-2-env"), "scm:git:https://github.com/flags-2-env/flags-2-env.git"))
