...
const packageControls = {
  ...
  erlang: [
    ...
    ["clients/erlang/rebar.config", /\{src_dirs, \["\.", "src"\]\}/, "Erlang rebar source directories include OTP app metadata"],
    ...
    ["clients/erlang/rebar.config", /\{files, \["flags2env\.erl", "src\/flags2env\.app\.src", "flags2env_nif\.c", "parser\.c", "parser\.h", "rebar\.config", "README\.md", "LICENSE"\]\}/, "Hex package file list"],
